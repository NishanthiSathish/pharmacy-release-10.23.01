--09Dec14  TH Version 4 : TEST VERSION FOR ANDREW TO CREATE TEST VIEWS ON SITE
...
--14Apr15 XN 115904 Updated Version number
...
exec pDrop 'vRxPrescriptionManagerPrintingInpatientTEST'
GO

CREATE  view [vRxPrescriptionManagerPrintingInpatientTEST] as
...
exec pDrop 'vRxPrescriptionManagerPrintingOutpatientTEST'
GO

CREATE  view [vRxPrescriptionManagerPrintingOutpatientTEST] as
...
exec pDrop 'vRxPrescriptionManagerPrintingLeaveTEST'
GO

CREATE  view [vRxPrescriptionManagerPrintingLeaveTEST] as
...
exec pDrop 'vRxPrescriptionManagerPrintingSelfMedTEST'
GO

CREATE  view [vRxPrescriptionManagerPrintingSelfMedTEST] as
...
-- Add to Version Log
INSERT VersionLog ([Type], Description, [Date]) SELECT 'Config', 'PrescriptionManagerPrinting.sql (10.12) v4', GETDATE()
GO