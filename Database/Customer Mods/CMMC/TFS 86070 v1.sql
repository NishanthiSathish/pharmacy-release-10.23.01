...
--29Apr14 TH Site Specific Patch for CMMC/Stockport.Includes Versioning additions TFS 86070
...
INSERT rVersionLog ([Type],Description,[Date]) SELECT 'Config', 'TFS 86070 v1', GETDATE()
GO
