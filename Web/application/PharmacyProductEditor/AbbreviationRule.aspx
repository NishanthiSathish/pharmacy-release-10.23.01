<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AbbreviationRule.aspx.cs" Inherits="application_PharmacyProductEditor_AbbreviationRule" %>
            ...
            <asp:UpdatePanel ID="upMain" runat="server">
                <ContentTemplate>
                    ...
                    <div style="position: absolute; right: 10px; bottom: 10px;">
                        <asp:Button ID="btnOK" runat="server" CssClass="PharmButton" Text="OK" OnClick="btnOK_OnClick" />
                    </div>
                </ContentTemplate>
            </asp:UpdatePanel>           
        </div>        
