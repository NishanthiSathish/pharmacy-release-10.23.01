<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FMAddStockAccountSheet.aspx.cs" Inherits="application_FinanceManagerStockAccountSheet_FMAddStockAccountSheet" %>
...
<body scroll="none">
    ...
    <icw:Container runat="server" Height="455px">
        <asp:UpdatePanel runat="server" UpdateMode="Conditional">
        <ContentTemplate>              
            <icw:Form runat="server" Caption="Date Range">
                <icw:DateTime runat="server" ID="dtStartDate" Mode="Date" Caption="Start Date" Mandatory="True"  Suffix="(from start of day)" />
                <icw:DateTime runat="server" ID="dtEndDate"   Mode="Date" Caption="End   Date" Mandatory="True"  Suffix="(upto start of day)" />                
            </icw:Form>
