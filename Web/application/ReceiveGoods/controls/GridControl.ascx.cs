...
//  create your own java script method if this needs to be handled (need to AllowDblClick).
//  Clicking row will cause a gridcontrol_onclick java event to be fired
//  create your own java script method if this needs to be handled (need to AllowClick).
//  
...
public partial class application_ReceiveGoods_controls_GridControl : System.Web.UI.UserControl, System.Web.UI.INamingContainer
{
    ...
    /// <summary>Control ID must be unique to the form</summary> 
    public string controlID { get; set; }

    protected List<ColumnInfo> columns = new List<ColumnInfo>();
    protected List<RowInfo>    rows    = new List<RowInfo>();

    public application_ReceiveGoods_controls_GridControl()
    {
    ...
    /// <summary>If allowed to click the gird</summary>
    public bool AllowClick { get; set; }

    /// <summary>
    /// Allowed click event for a check box 
    /// (web page must have a javascript gridcontrol_checkboxclick(row, column) method defined)
    /// </summary>
    ...
    /// </summary>
    /// <param name="row">Row index</param>
    /// <param name="visible">If row viislbe</param>
    ...
    {
        // Check the column is a check box
