<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ICW_PharmacySupplierEditor.aspx.cs" Inherits="application_PharmacySupplierEditor_ICW_PharmacySupplierEditor" %>
...
<head runat="server">
    <title>Pharmacy Supplier Editor</title>
    <base target="_self" />
    ...
    <script type="text/javascript" src="script/PharmacySupplierEditor.js"                       async></script>
...
<body onload="body_onload();" onresize="body_resize();">
    ...
    <div class='icw-container-fixed' style="padding-left:5px;padding-right:5px;">
        ...
        <ContentTemplate>
            <table style="width:100%">
                <tr style="height:22px;vertical-align:top;">
                    <td style="width:68%"><span class="titleLabel">Supplier:</span>&nbsp;<span id="lbSupplier" runat="server" class="titleValue" /></td>
        ...
        <hr />
            ...
            <ContentTemplate>
                <div id="divEditorControl" style="padding-top:5px;padding-left:10px;">
                    <asp:HiddenField ID="hfSelectedCode" runat="server" />
                    <asp:HiddenField ID="hfWSupplierID"  runat="server" />
