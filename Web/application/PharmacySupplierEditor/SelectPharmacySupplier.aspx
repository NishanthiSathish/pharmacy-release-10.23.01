<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectPharmacySupplier.aspx.cs" Inherits="application_PharmacySupplierEditor_SelectPharmacySupplier" %>
...
<script src="../sharedscripts/InactivityTimeout.js" type="text/javascript"></script>
     <script type="text/javascript" FOR="window" EVENT="onload">
         ...
         var pageName = "SelectPharmacySupplier.aspx";
...
<% } %>
    ...
    <script type="text/javascript" src="script/SelectPharmacySupplier.js"                async></script>
...
<body onload="body_onload()" onkeydown="body_onkeydown()">
    ...
    <div class="icw-container" style="height:480px;padding:10px;">
    <asp:UpdatePanel ID="upMain" runat="server">
    <ContentTemplate>
        <!-- Search results grid -->
        <div id="divGrid" style="height:325px;">
