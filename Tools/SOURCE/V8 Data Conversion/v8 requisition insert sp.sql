...
IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'pV8WRequisitionInsert' 
	   AND 	  type = 'P')
    DROP PROCEDURE pV8WRequisitionInsert
GO

CREATE PROCEDURE pV8WRequisitionInsert 
	(
