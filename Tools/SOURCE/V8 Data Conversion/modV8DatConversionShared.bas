...
Public Enum LibErrorEnum
   ...
   erInvalidPNCode = vbObjectError + 10302                                                                        '15Jul13 XN  35617 Added used when converting single PN Product or Rule
   erInvalidPNRule = vbObjectError + 10303                                                                        '15Jul13 XN  35617 Added used when converting single PN Product or Rule   
   erPNRuleNoLongerSupported = vbObjectError + 10304                                                              '15Jul13 XN  35617 Added used when converting single PN Product or Rule   
...
' Revision History
' 4Sep02 PH Created
'15Jul13 XN 35617 Added erInvalidPNCode, erInvalidPNRule, erPNRuleNoLongerSupported
'
'------------------------------------------------------------------------'
   ...
   Select Case lngErrorNumber
      ...
      Case erInvalidSessionID
         strDescription = "Invalid SessionID passed to the transport layer."
      ...
      Case erInvalidPNCode
         strDescription = "Invalid PN Code: "
      Case erInvalidPNRule
         strDescription = "Invalid PN Rule Number: "
      Case erPNRuleNoLongerSupported
         strDescription = "Rule is no longer supported in v10. Rule Number: "
      Case Else
...
'                                        & "The procedure must be rebuilt correctly before you can continue."))
      ...
      Case Else
         ConvertErrorToBrokenRulesXML = FormatBrokenRulesXML(FormatBrokenRuleXML(CStr(ErrorState_OUT.Number), ErrorState_OUT.Description, ErrorState_OUT.source))
   End Select
